...
func (i *Inventory) Reserve(_ context.Context, reservation core.StockReservation) error {
	i.mu.Lock()
	defer i.mu.Unlock()
...
func (i *Inventory) Release(_ context.Context, release core.StockRelease) error {
	i.mu.Lock()
	defer i.mu.Unlock()
